#ifndef BRANCH_MARKOV_MODEL_2_H
#define BRANCH_MARKOV_MODEL_2_H
...
// REALIZATION OF HEADER FILE IS THE SAME AS FOR MODEL 1
class markov_model_2 : champsim::modules::branch_predictor
{
